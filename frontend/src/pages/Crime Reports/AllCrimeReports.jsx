              ...
              <main className="col-span-12 md:col-span-9 space-y-4">
                {filteredReports.some((r) => r.status === "approved") && (
                  <div className="relative">
                    ...
                    <MapContainer
                      center={
                        region ? [region.lat, region.lng] : [23.8041, 90.4152]
                      }
                      zoom={region ? 14 : 11}
                      zoomControl={false}
                    ...
                    <Button
                      ...
                      } cursor-pointer absolute top-12 right-2 z-997 hover:bg-slate-400 hover:text-white transition duration-300 ease-in-out`}
